...
## Purpose
Defines requirements for a horizontally-optimized, compact tool card layout that displays key information inline rather than vertically stacked, enabling 2-3x more tools to be visible on screen.
